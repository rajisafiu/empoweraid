...
import { FiSend, FiCheckCircle, FiHome, FiAlertCircle, FiX, FiInfo } from "react-icons/fi";
...
function ApplicationPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(import.meta.env.VITE_DATAFORM, {
        method: "POST",
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-600 text-lg">
            Complete the form below to apply for the EmpowerAid program.
          </p>
        </div>

        {/* --- NEW PROGRAM INFORMATION CARD --- */}
        <div className="bg-green-50 border border-green-200 rounded-3xl p-6 md:p-8 mb-8 shadow-sm">
          <div className="flex items-center gap-3 mb-4 text-green-800">
            <FiInfo size={24} className="shrink-0" />
            <h2 className="font-black text-xl tracking-tight uppercase">About the Program</h2>
          </div>
          <p className="text-green-900/80 leading-relaxed font-medium">
            This grant program is designed to provide immediate financial relief to individuals facing tough economic conditions. 
            Whether you need help with <strong> medical expenses, business growth, college tuition, school fees, or personal bills</strong>, 
            this initiative aims to eradicate poverty and empower you to build a better future. 
            This is a free grant provided to make the world a better place for everyone. 
          </p>
          <div className="mt-4 flex flex-wrap gap-4 text-[10px] md:text-xs font-bold text-green-700 uppercase tracking-widest">
            <span className="bg-white/50 px-3 py-1.5 rounded-full border border-green-200/50">✓ Direct Financial Support</span>
            <span className="bg-white/50 px-3 py-1.5 rounded-full border border-green-200/50">✓ Global Poverty Initiative</span>
          </div>
        </div>
