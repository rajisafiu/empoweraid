...
//               <Link to="/contact" className="bg-blue-900 hover:bg-blue-800 text-white px-6 py-3 rounded-lg transition">
//                 Learn More
//               </Link>
//             </div>
//           ))}
...
const Home = () => {
  return (
    <div id="home"> {/* Changed section to div for better semantic nesting */}
      <Hero backgroundImage="https://st.depositphotos.com/1743476/1276/i/450/depositphotos_12760601-stock-photo-loving-senior-couple.jpg" />
      <HelpingSection />
      ...
      <section id="programs" className="py-20 px-6 md:px-16 bg-white">
        <div className="text-center mb-14">
          ...
          <div className="h-2 w-24 bg-green-500 mx-auto mb-8 rounded-full"></div>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Explore our structured financial assistance programs...
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {programs.map((program, index) => (
            ...
            >
              ...
              {/* Added display: inline-block to ensure the link respects padding/height */}
              <Link 
                to="/contact" 
